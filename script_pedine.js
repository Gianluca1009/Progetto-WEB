...
function posizion_iniziali(){
    ...
    torre_bianca.src = "images/pedone_bianco.png";
    torre_bianca.alt = "Torre nera";
    torre_nera.src = "images/pedone_nero.png";
    ...
    alfiere_bianco.src = "images/pedone_bianco.png";
    alfiere_bianco.alt = "Alfiere bianco";
    alfiere_nero.src = "images/pedone_nero.png";
    ...
    regina_bianca.src = "images/pedone_bianco.png";
    regina_bianca.alt = "Regina bianca";
    regina_nera.src = "images/pedone_nero.png";
    ...
    re_bianco.src = "images/pedone_bianco.png";
    re_bianco.alt = "Re bianco";
    re_nero.src = "images/pedone_nero.png";
    re_nero.alt = "Re nero";
    ...
    cavallo_bianco.src = "images/pedone_bianco.png";
    cavallo_bianco.alt = "Cavallo bianco";
    cavallo_nero.src = "images/pedone_nero.png";
    ...
    for (let i = 0; i < 6; i++) {
        ...
        pedone_bianco.src = "images/pedone_bianco.png";
        pedone_bianco.alt = "Pedone bianco";
        pedone_nero.src = "images/pedone_nero.png";
